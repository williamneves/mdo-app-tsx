...
const TabSecurity = () => {
  ...
  const schema = yup.object().shape({
    ...
    confirmPassword: yup.string()
      .test("equal", "As senhas não conferem", (value) => verifyPasswordEquality(value as string))
  ...
  const PasswordAdornment = ({ showPasswordState, setShowPassword }: PasswordAdornmentProps) => (
    <IconButton
