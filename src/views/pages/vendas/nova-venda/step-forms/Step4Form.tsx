      ...
      <Grid container spacing={5} key={4}>
        ...
        <Grid item xs={12}>
          <Alert severity="info" sx={{ marginBottom: 5 }}>
            <Typography variant="body2">
              Revise os dados abaixo, e se precisar fazar alguma
              alteração, clique em{" "}
              <ModeEditIcon sx={{ fontSize: "14px" }} /> <b>EDITAR</b>.
            </Typography>
            <Typography variant="body2">
        ...
        <Grid item xs={12} sm={6} lg={4}>
          <TextField
            ...
            id="form-props-required"
            label={"Data da Venda"}
            defaultValue={moment(step4Data["date"]).format(
              "DD/MM/YYYY"
            )}
            inputProps={{
              readOnly: true
