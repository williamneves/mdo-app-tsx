...
// ** Rendered Element
interface MetaPrincipalIndexProps {

}

const MetaPrincipalIndex = ({}: MetaPrincipalIndexProps): JSX.Element => {
    ...
    <Grid container spacing={6} className="match-height">
      <PageHeader
        ...
        subtitle={<Typography variant="subtitle1">
          Abaixo estão os cards com as metas principais do ano {moment().format("YYYY")}.
        </Typography>}
      />
