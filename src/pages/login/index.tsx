        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              ...
              <Typography variant="body2">Por favor entre com a sua conta e comece a aventura</Typography>
            </Box>
            ...
            <form noValidate autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", flexWrap: "wrap", justifyContent: "center" }}>
                <Typography sx={{ mr: 2, color: "text.secondary" }}>Novo na nossa plataforma?</Typography>
                <Typography>
