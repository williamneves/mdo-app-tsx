...
const Faq = ({faqPosts}: { faqPosts: FaqPost[] }) => {
  ...
  const categories = filteredPosts.map((faqPost) => faqPost.category).flat().filter((value, index, self) => self.indexOf(value) === index);
    ...
    <Grid container spacing={6}>
      <Grid item xs={12} sx={{display: "flex", alignItems: "center", flexDirection: "column", gap: 3}}>
        ...
        >
          ...
          <Typography variant="subtitle2" textAlign={'center'} paddingX={4} gutterBottom>
