...
const filterSales = (sales: Array<Sale>, inputValue: string):Array<Sale> => {
  const filterKeys = ["client.name", "status", "paymentMethod.title", "saleNumber", "saleAmount", "date", "PDVNumber", "auditStatus", "score", "markup", "profit", "totalCost", "totalDiscount", "totalQuantity"];
