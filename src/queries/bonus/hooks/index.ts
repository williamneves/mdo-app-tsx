...
export const getBonusByReferenceId = async (
  referenceId: string
): Promise<IBonus[]> => {
  try {
    return await dbClient.fetch(bonusByReferenceIdGROQ, {
...
export const createBonus = async (bonus: IBonus): Promise<IBonus> => {
  ...
  try {
    bonus._type = "bonus"
    return await dbClient.create(newBonus as any, {
...
// ** Update Bonus fields
export const updateBonusFields = async (
  bonusId: string,
